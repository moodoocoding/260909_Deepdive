...
export function MissionThree({ onBack, onComplete }: { onBack: () => void; onComplete: () => void }) {
  ...
  return (
    <div className="mx-auto w-full max-w-[1050px] px-5 pb-16 pt-8 sm:px-8 lg:px-10 lg:pt-10">
      <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
        ...
        <span className="rounded-full bg-[#e9f5f3] px-3 py-1.5 text-xs font-bold text-[#0d7771]">MISSION 03 · 컴퓨터 안의 인공지능</span>
      </div>
